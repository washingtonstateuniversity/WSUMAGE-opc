...
class Wsu_Opc_IndexController extends Mage_Checkout_Controller_Action {
	const XML_PATH_TITLE = 'wsu_opc/global/title';
	...
	protected function initDefaultAddress() {
		...
		$ip_country =  Mage::getStoreConfig(self::XML_PATH_GEO_COUNTRY) ? Mage::helper('wsu_opc/country')->get() : $countryId;
		$countryId =  !empty($ip_country)?$ip_country:$countryId;
		$ip_city =  Mage::getStoreConfig(self::XML_PATH_GEO_CITY) ? Mage::helper('wsu_opc/city')->get() : false;
