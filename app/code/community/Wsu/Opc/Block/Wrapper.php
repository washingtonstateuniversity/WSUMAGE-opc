...
class Wsu_Opc_Block_Wrapper extends  Mage_Core_Block_Template {
	...
	public function getJsonConfig() {
		...
		$config['geoCountry'] =  Mage::getStoreConfig(self::XML_PATH_GEO_COUNTRY) ? Mage::helper('wsu_opc/country')->get() : false;
		$config['geoCity'] =  Mage::getStoreConfig(self::XML_PATH_GEO_CITY) ? Mage::helper('wsu_opc/city')->get() : false;
