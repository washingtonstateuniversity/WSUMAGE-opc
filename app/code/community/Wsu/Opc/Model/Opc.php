<?php
class Wsu_Opc_Model_Launcher extends Mage_Core_Model_Abstract {
    const CONFIG_CACHE_ID = 'wsu_opc_config';
    protected $_config;
    ...
    protected function _initConfig( ) {
        ...
        if ( false !== $data ) {
            ...
            $xml  = Mage::getConfig()->loadModulesConfiguration( 'opc.xml' )->getNode();
            $data = $xml->asArray();
