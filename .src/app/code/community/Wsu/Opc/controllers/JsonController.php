...
class Wsu_Opc_JsonController extends Mage_Core_Controller_Front_Action
{
    ...
    */
    ...
    public function checkNewslatter()
    {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if (!isset($result['error'])) {
                ...
                if ($use_method != -1) {
                    ...
                    $result['payments'] = $this->_getPaymentMethodsHtml(!empty($use_method) ? $use_method : -1, true);
    ...
    */
    public function saveShippingAction()
    {
        ...
        //comeback to create response if post not exist
        $responseData = array();
    ...
    */
    ...
    public function savePaymentAction()
    {
        ...
        try {
            ...
            if (empty($result['error'])) {
                ...
                $result['grandTotal'] = Mage::helper('wsu_opc')->getGrandTotal();
            }
            if ($redirectUrl) {
    ...
    public function saveComments($request)
    {
        ...
        if (Mage::helper('wsu_opc')->isShowComment()) {
            $comment = $request->getPost('customer_comment', '');
            if (empty($comment)) {
    ...
    */
    public function saveOrderAction()
    {
        ...
        try {
            ...
            $this->saveComments($this->getRequest());
            ...
            $result['error'] = !empty($message) ? $message : "";
