...
class Wsu_Opc_Helper_Paypal extends Mage_Customer_Helper_Data
{
    ...
    const XML_PATH_ENABLED = 'wsu_opc/paypallogin/status';

    const XML_PATH_SANDBOX_MODE = 'wsu_opc/paypallogin/sandbox';

    const XML_PATH_CLIENT_ID = 'wsu_opc/paypallogin/clientid';

    const XML_PATH_CLIENT_SECRET = 'wsu_opc/paypallogin/secret';
